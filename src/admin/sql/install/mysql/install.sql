...
-- -----------------------------------------------------
-- Table `ext53_oscampus_courses_modules`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ext53_oscampus_courses_modules` ;

CREATE TABLE IF NOT EXISTS `ext53_oscampus_courses_modules` (
  `courses_id` INT NOT NULL,
  `modules_id` INT NOT NULL,
  PRIMARY KEY (`courses_id`, `modules_id`),
  INDEX `idx_modules_courses` (`modules_id` ASC),

...
-- -----------------------------------------------------
-- Table `ext53_oscampus_courses_required`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ext53_oscampus_courses_required` ;

CREATE TABLE IF NOT EXISTS `ext53_oscampus_courses_required` (
  `courses_id` INT NOT NULL,
  `required_id` INT NOT NULL,
  PRIMARY KEY (`courses_id`, `required_id`),
  INDEX `courses_prerequisite_idx` (`required_id` ASC),
  CONSTRAINT `courses_parent`
    FOREIGN KEY (`courses_id`)
    REFERENCES `ext53_oscampus_courses` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `courses_required`
